...
export default function Apples() {
  ...
  // Filter farmer details based on search location
  const filteredFarmerDetails = farmerDetails.filter((farmer) =>
    farmer.location.toLowerCase().includes(searchLocation.toLowerCase())
  );
  ...
  const addToCart = async (product) => {
    try {
      ...
      // Include username in the product object
